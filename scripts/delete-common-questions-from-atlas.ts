...
async function deleteCommonQuestionsFromAtlas() {
  try {
    ...
    // البحث عن الأسئلة العامة (300 سؤال) فقط
    const query = {
    ...
    console.log(`📊 Found ${countBefore} common questions (300-Fragen) in Atlas\n`);
    ...
    // التحقق من عدد الأسئلة المتبقية (أسئلة الولايات)
