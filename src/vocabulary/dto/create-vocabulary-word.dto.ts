...
export class CreateVocabularyWordDto {
  ...
  @ApiProperty({
    required: false,
    description:
      'المعنى كـ string مفصولة بـ / (للتوافق مع البيانات القديمة) - مثال: "بيت / house / maison"',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    ...
    description:
      'مصفوفة المعاني (الصيغة الجديدة) - مثال: [{text: "بيت", language: "ar"}, {text: "house", language: "en"}]',
  })
  @IsOptional()
  @IsArray()
