...
import { SchreibenTask, SchreibenTaskSchema } from './schemas/schreiben-task.schema';

@Module({
  imports: [MongooseModule.forFeature([{ name: SchreibenTask.name, schema: SchreibenTaskSchema }])],
